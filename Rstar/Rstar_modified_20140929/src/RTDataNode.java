...
public final class RTDataNode extends RTNode implements Node
{
    ...
    */
    ...
    //HJ 20140927 Type chnage float -> double
  ...
  //HJ 20140927 SAT. parameter Type change float -> double
    ...
    //#endif // S3
    */
  //HJ 20140927 SAT. parameter and variables Type change float -> double
  ...
  //HJ 20140927 SAT. parameter and variables Type change float -> double
    public void range_nnQuery(double mbr[],SortedLinList res,
                    PPoint center, double nearest_distanz,
    ...
    */
	...
	public void NearestNeighborSearch(PPoint point, PPoint Nearest,
			float nearest_distanz) {
		// TODO Auto-generated method stub
		
	}

	public void NearestNeighborSearch(PPoint point, SortedLinList res,
			float nearest_distanz) {
		// TODO Auto-generated method stub
	...
	public void range_nnQuery(float[] mbr, SortedLinList res, PPoint center,
			float nearest_distanz, PPoint nearest, boolean success) {
		// TODO Auto-generated method stub
