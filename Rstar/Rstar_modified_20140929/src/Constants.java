...
/* These values are now set by the users - see UserInterface module.*/
    ...
    ////////////////////////////////////////////////////////////////////////////
    //HJ 20140927 SAT. ORIGIN SOURCE CODE 
    /*
	...
	*/
    ...
    // to the axes
  //HJ 20140927 SAT. Type change float -> double
    public static float margin(int dimension, double[] rxmbr)
    {
        int i;
        int ml, mu, m_last;
        float sum;
  ...
  //HJ 20140927 SAT. parameter Type change float -> double
    public static boolean inside(double v, double mbr, double ub)
    {
        return (v >= mbr && v <= ub);
    }
  ...
  //HJ 20140927 SAT. Type change float -> double
    public static double overlap(int dimension, double[] rxmbr, double[] rymbr)
    {
        double sum;
    ...
    */
    //HJ 20140927 SAT. Parameter type change float -> double
    public static boolean section(int dimension, double[] dmbr, double[] mbr)
    {
        int i;

        for (i = 0; i < dimension; i++)
        {
            if (dmbr[2*i] > mbr[2*i + 1] || dmbr[2*i + 1] < mbr[2*i])
                return false;
        }
        return true;
    }
  ...
  //HJ 20140927 SAT. parameter Type change float -> double
    ...
    */
    public static boolean section_ring(int dimension, double mbr1[], Object center, float radius1, float radius2)
    {
        ...
        //if ((MINDIST(center,mbr1) != 0) ||
        //    (((r2 - MINDIST(center,mbr1)) < (float)1.0e-8)))
        if (((r_c1 - MAXDIST(center,mbr1)) < 1.0e-8) &&
            ((MINDIST(center,mbr1) - r_c2) < 1.0e-8))
                return true;
        else
                return false;
    }
    ...
    */
    //HJ 20140927 SAT. return type Type change float -> double
    public static double MINDIST(Object pt, double[] mbr1)
    {
        //
      ...
      //HJ 20140927 SAT. Type change float -> double
        ...
        {
            if (point.data[i] < mbr1[2*i])
                r = mbr1[2*i];
            else
            {
                if (point.data[i] > mbr1[2*i+1])
                            r = mbr1[2*i+1];
                else
                            r = point.data[i];
            }
    ...
    */
  //HJ 20140927 SAT. Type change float -> double
    public static double MAXDIST(Object pt, double bounces[])
    {
        PPoint point = (PPoint)pt;
      //HJ 20140927 SAT. Type change float -> double
        double sum = 0.0;
    ...
    */
    //HJ 20140927 SAT. return Type change float -> double
    public static double MINMAXDIST(PPoint point, double[] bounces)
    {
    ...
    //HJ 20140927 SAT. parameter Type change float -> double
    public static void check_mbr(int dimension, double mbr[])
    {
    }
    //HJ 20140927 SAT. parameterType change float -> double
    public static rectangle toRectangle (double[] data)
    {
